...
public class CardDesign {
    ...
    *** GREEN CARDS ********************************
    ...
    private final String[] greenOne = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        ...
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X    " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "                X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "               X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
    ...
    private final String[] greenKing = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X    " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "           " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "    X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
    ...
    private final String[] greenNine = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X          " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "          X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X    " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "    " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "    " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "    X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X    " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "           " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "    X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + GREEN_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
    ...
    *** YELLOW CARDS ********************************
    ...
    private final String[] yellowOne = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        ...
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X    " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "                X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "               X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        RESET_TEXT_COLOR + " " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " "};
    ...
    private final String[] yellowKing = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X    " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "           " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "    X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
    ...
    private final String[] yellowNine = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X          " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "          X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X    " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "    " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "    " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "    X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X    " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "           " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "," + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "    X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + YELLOW_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
    ...
    *** BLUE CARDS **********************************
    ...
    private final String[] blueOne = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        ...
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + " _ " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "               X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + "(O)" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "               X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        RESET_TEXT_COLOR + " " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " "};

    private final String[] blueKing = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + " _ " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + " _ " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + "(O)" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + "(O)" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
    ...
    private final String[] blueNine = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X         " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + " _ " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "         X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + " _ " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "   " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + "(O)" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "   " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + " _ " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + "(O)" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + "(O)" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + " _ " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + " _ " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + "(O)" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + BLUE_BACKGROUND + WHITE_TEXT + "(O)" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
    ...
    *** RED CARDS *******************************
    ...
    private final String[] redOne = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        ...
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + RED_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "               X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X    " + RESET_TEXT_COLOR + setBoldText + RED_BACKGROUND + WHITE_TEXT + "V" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "                X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        RESET_TEXT_COLOR + " " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " "};

    private final String[] redKing = {" " + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X   " + RESET_TEXT_COLOR + setBoldText + RED_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "         " + RESET_TEXT_COLOR + setBoldText + RED_BACKGROUND + WHITE_TEXT + "< >" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "   X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X    " + RESET_TEXT_COLOR + setBoldText + RED_BACKGROUND + WHITE_TEXT + "V" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + WHITE_TEXT + "           " + RESET_TEXT_COLOR + setBoldText + RED_BACKGROUND + WHITE_TEXT + "V" + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "    X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "X                     X" + RESET_TEXT_COLOR,
    ...
    *** SPECIÁLNÍ KARTY ******************************
    ...
    private final String[] nonameCard = {" " + setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "XXXXXXXXXXXXXXXXXXXXX" + RESET_TEXT_COLOR + " ",
        setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "X                     X" + RESET_TEXT_COLOR,
        setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "X       " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "******" + RESET_TEXT_COLOR + setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "        X" + RESET_TEXT_COLOR,
        setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "X      " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "**" + RESET_TEXT_COLOR + setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "    " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "**" + RESET_TEXT_COLOR + setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "       X" + RESET_TEXT_COLOR,
        setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "X      " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "**" + RESET_TEXT_COLOR + setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "    " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "**" + RESET_TEXT_COLOR + setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "       X" + RESET_TEXT_COLOR,
        setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "X            " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "**" + RESET_TEXT_COLOR + setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "       X" + RESET_TEXT_COLOR,
        setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "X          " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "**" + RESET_TEXT_COLOR + setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "         X" + RESET_TEXT_COLOR,
        setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "X          " + RESET_TEXT_COLOR + setBoldText + WHITE_BACKGROUND + BLACK_TEXT + "**" + RESET_TEXT_COLOR + setBoldText + PURPLE_BACKGROUND + WHITE_TEXT + "         X" + RESET_TEXT_COLOR,
